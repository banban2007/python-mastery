...
Button(root,text="C",width=5,height=1,font=("ariel",30,"bold"),bd=1,fg="#fff",bg="#3697f5",command=lambda: clear()).place(x=10,y=100)
Button(root,text="/",width=5,height=1,font=("ariel",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("/")).place(x=150,y=100)
Button(root,text="%",width=5,height=1,font=("ariel",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("%")).place(x=290,y=100)
...
Button(root,text="<-",width=5,height=1,font=("ariel",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: back()).place(x=10,y=500)
Button(root,text="0",width=5,height=1,font=("ariel",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show("0")).place(x=150,y=500)
Button(root,text=".",width=5,height=1,font=("ariel",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda: show(".")).place(x=290,y=500)

Button(root,text="=",width=5,height=3,font=("ariel",30,"bold"),bd=1,fg="#fff",bg="#fe9037",command=lambda: calculate()).place(x=430,y=400)
